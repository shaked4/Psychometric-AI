...
export function OverviewHeader({ totalAnswered, accuracyPct, streakDays, avgTimeSeconds }: OverviewHeaderProps) {
  const stats = [
    { label: "שאלות שנפתרו", value: String(totalAnswered) },
    { label: "דיוק כללי", value: `${accuracyPct}%` },
    { label: "מהירות ממוצעת לשאלה", value: formatAvgTime(avgTimeSeconds) },
  ...
  return (
    <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
      {stats.map((stat) => (
        ...
        >
          <p dir="ltr" className="text-3xl font-bold tracking-tight text-card-foreground">
            {stat.value}
          </p>
